...
import com.example.codequantum_project.Model.Gameplay;  // Import the Gameplay class
import com.example.codequantum_project.Model.Checker;  // Import the Checker class
...
public class GameplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameplay = new Gameplay();  // Initialize Gameplay object
